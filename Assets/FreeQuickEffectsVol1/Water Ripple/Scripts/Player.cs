...
namespace WaterRipple
{
    public class Player : MonoBehaviour
    {
        ...
        void PlayerMovement()
        {
            ...
            Vector3 move = camRight.normalized * Input.GetAxis("Horizontal") +
        ...
        void CreateRipple(int Start, int End, int Delta, float Speed, float Size, float Lifetime)
        {
            ...
            {
                ripple.Emit(transform.position + ripple.transform.forward * 1.15f, ripple.transform.forward * Speed,
                    Size,
                    Lifetime, Color.white);
